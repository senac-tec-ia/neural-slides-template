...
|---|---|---|
| 2026-03-05 | Blocos longos de teoria causaram dispersao na Aula 03 anterior | Regra de max 1-2 slides de teoria consecutivos adicionada ao agente |
| 2026-03-05 | Debates abertos nao funcionaram bem | Substituir por perguntas tecnicas dirigidas ou dinamicas em dupla |
...
|---|---|---|
| GPU e paralelismo | Arquitetura de Computadores e GPU | Ja introduzido superficialmente; aprofundar na UC especifica |
| Python como ferramenta | Python para IA | Esta UC e a base que sustenta Python para IA |
| CSV e dados estruturados | Banco de Dados | Pre-requisito pratico introduzido no Calc |
